        ...
        <div className="flex">
            ...
            <div id="fullscreen-menu">
                <div id="redDiv" className="vertical-div  z-[10000] pt-4 flex flex-col justify-evenly items-center red">
                    ...
                    <ul>
                        <li className='pb-4 text-2xl text-white'>About Us</li>
                        <li className='pb-4 text-2xl text-white'>Our Services </li>
                        <li className='pb-4 text-2xl text-white'>Our Projects </li>
                        <li className='pb-4 text-2xl text-white'>Our Pricing </li>
                        <li className='pb-4 text-2xl text-white'>Our Blogs  </li>
                        <li className='pb-4 text-2xl text-white'>Our Location </li>
                        <li className='pb-4 text-2xl text-white'>Our News </li>
                    </ul>
